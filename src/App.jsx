    ...
    <div style={{...BASE_BG,display:"flex",flexDirection:"column",minHeight:"100vh"}}>
      ...
      <div style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"32px 16px"}}>
        <div style={{textAlign:"center",marginBottom:36}}>
          ...
          <div style={{fontFamily:"sans-serif",fontSize:13,color:"#ffdf00",letterSpacing:4,marginTop:6}}>
          ...
          <div style={{display:"flex",gap:8,marginBottom:16}}>
            {[["entrar","🔑 Acessar meu Bolão"],["cadastrar","➕ Sou novo Administrador"]].map(([t,l])=>(
              <button key={t} onClick={()=>{setTab(t);setErr("");}}
                style={{flex:1,background:tab===t?"linear-gradient(135deg,#009c3b,#006622)":"rgba(255,255,255,.06)",
                  color:"#fff",border:`2px solid ${tab===t?"#009c3b":"#333"}`,
                  borderRadius:10,padding:"10px",cursor:"pointer",fontSize:13,fontWeight:700,transition:".2s"}}>
                {l}
              </button>
            ))}
          </div>
